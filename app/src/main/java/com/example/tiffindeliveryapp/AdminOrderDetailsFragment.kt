 ...
 * Use the [AdminOrderDetailsFragment.newInstance] factory method to
...
class AdminOrderDetailsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AdminOrderDetailsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AdminOrderDetailsFragment().apply {
