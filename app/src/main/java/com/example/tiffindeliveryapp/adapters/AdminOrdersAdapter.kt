...
class AdminOrdersAdapter(var ordersList:ArrayList<NewOrder>): RecyclerView.Adapter<AdminOrdersAdapter.OrderListViewHolder>(){
    ...
    override fun onBindViewHolder(holder: OrderListViewHolder, position: Int) {
        holder.serviceTitle.text = ordersList[position].userName
    ...
    class OrderListViewHolder(itemView: View, listener: AdminOrdersAdapter.OnItemClickListener) :
