...
class OTPLoginFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.getParcelable("resendToken",PhoneAuthProvider.ForceResendingToken::class.java)?.let {
            resendToken = it
            Log.d("TAG", "onCreate: ${resendToken}")
        }
    ...
    private fun sendToMain() {
        val mAuthListener = context as AuthenticationActivity
